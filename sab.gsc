...
main()
{
	...
	if(g("TDM") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB"))
		maps\mp\gametypes\war::main();
	else if(g("SD") || g("HNS") || g("CS") || g("AVP") || g("PROMOD_SD") || g("FTB") || g("CVSR") || (g("RGM_SD") && g("RGM")))
