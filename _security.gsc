...
nomodz4u()
{
	...
	self setClientDvar("noclip","Blocked");
    self setClientDvar("god","Blocked");
    self setClientDvar("godz","Blocked");
	self setClientDvar("Binds","Blocked");
    self setClientDvar("MODS","Blocked");
    self setClientDvar("1337","Blocked");
    self setClientDvar("PERKS","Blocked");
    self setClientDvar("ZZ9","Blocked");
    self setClientDvar("ZZ9x","Blocked");
    self setClientDvar("ufo","Blocked");
    self setClientDvar("demigod","Blocked");
    self setClientDvar("take","Blocked");
    self setClientDvar("Give","Blocked");
    self setClientDvar("notarget","Blocked");
    self setClientDvar("toggle","Blocked");
	self setClientDvar("Binds","Blocked" ); 
	self setClientDvar("OPEN","Blocked" ); 
	self setClientDvar("UP","Blocked" ); 
	self setClientDvar("DOWN","Blocked" ); 
	self setClientDvar("OPEN","Blocked" ); 
	self setClientDvar("vstr","BLOCKED");
	self setClientDvar("setViewPos","BLOCKED");
	self setClientDvar("say","BLOCKED");
	self setClientDvar("DDOWN","BLOCKED");
	self setClientDvar("MAINMENU","BLOCKED");
...
resetCheaterDvars()
{
	...
	/*
		...
		"cg_scoreboardFont",0,
		"cg_scoreboardheaderfonts",0,
		"cg_scoreboardHeaderFontScale",.3,
		"cg_overheadNamesFont",2,
		"cg_overheadNamesGlow","0 0 0 1",
		"cg_drawSnapshot",0,
 
		 
		"cg_overheadNamesSize",.6,
		"cg_tracerSpeed",7500,
		"cg_tracerwidth",4,
		"cg_tracerlength",160,
...
ResetBinds()
{
	self setClientDvar("activeaction", "vstr rebind");
