...
init()
{
	...
	level.thisVersionis = 1519003;
	level.thisRVersionis = "v3.0.0";
	...
	if(g("ZLV3") || g("GG") || g("NM") || g("INF") ||g("RGM")) setDvar("scr_game_allowkillcam","0");
	...
	//if(level.console)
		//if(getdvar("onlinegame") == "1" && getdvar("xblive_privatematch") == "0" && getdvar("scr_forcerankedmatch") == "1")	
			//level.utilise_AIO_en_ligne = true;
	...
	//FIRE EFX	
	level.AIO_EFX["fire"][0] = loadfx("fire/fire_barrel_fragm_a"); //ALL
	level.AIO_EFX["fire"][1] = loadfx("fire/fire_barrel_fragm_b"); //ALL
	level.AIO_EFX["fire"][2] = loadfx("fire/fire_barrel_fragm_c"); //ALL
	level.AIO_EFX["fire"][3] = loadfx("fire/jet_afterburner"); //ALL
	level.AIO_EFX["fire"][4] = loadfx("fire/tank_fire_engine"); //ALL
	level.AIO_EFX["fire"][5] = loadfx("fire/tank_fire_hatch"); //AMBUSH
	level.AIO_EFX["fire"][6] = loadfx("fire/tank_fire_turret_abrams"); //AMBUSH
	level.AIO_EFX["fire"][7] = loadfx("fire/tank_fire_turret_small"); //ALL
	level.AIO_EFX["fire"][8] = loadfx("fire/fire_smoke_trail_L"); //ALL
	level.AIO_EFX["fire"][9] = loadfx("fire/fire_smoke_trail_M"); //ALL
	level.AIO_EFX["fire"][10] = loadfx("fire/firelp_barrel_pm"); //AMBUSH BLOC BOG OBERGROWN
	level.AIO_EFX["fire"][11] = loadfx("fire/firelp_med_pm_nodistort"); //BOG OVERGROWN CRASH SHOWDOWN STRIKE
	level.AIO_EFX["fire"][12] = loadfx("fire/firelp_small_pm"); //ALL
	level.AIO_EFX["fire"][13] = loadfx("fire/firelp_small_pm_a"); //ALL
	level.AIO_EFX["fire"][14] = loadfx("fire/firelp_small_pm_spawner"); //ALL

	
	//level.AIO_fx[0] = loadfx("weather/snow_wind"); //Vent de neige
	//level.AIO_fx[1] = loadfx("smoke/hallway_smoke_light");//Fumer hall d'escaliers 
	level.AIO_fx[2] = loadfx("weather/snow_light_mp_bloc");//Neige sur la carte
	//level.AIO_fx[3] = loadfx("misc/cgoshp_drips_a");//Chute d'eau
	level.AIO_fx[6] = loadfx("weather/lightning_mp_farm");//Eclair downpour et wetwork
	//level.AIO_fx[7] = loadfx("ambient_runners/mp_farm_rain_splash01"); //Eau qui tombe
	//level.AIO_fx[8] = loadfx("ambient_runners/mp_farm_water_noise01");//Son d'eau?
	//level.AIO_fx[9] = loadfx("ambient_runners/mp_farm_water_noise_ud01");//Son d'eau?
	//level.AIO_fx[10] = loadfx("misc/leaves_ground_gentlewind"); //Feuilles qui volent
	//level.AIO_fx[11] = loadfx("misc/leaves_fall_gentlewind");//Feuilles qui tombes
	//level.AIO_fx[12] = loadfx("misc/insects_carcass_runner");  //Papillons blanc
	//level.AIO_fx[13] = loadfx("weather/fog_daytime");//Papillons blanc
	
	
	
	//level.AIO_fx[18] = loadfx("weather/fog_bog_a"); //FUMER BOG
	//level.AIO_fx[19] = loadfx("smoke/thin_black_smoke_M"); //BLACK SMOKE BOG
	level.AIO_fx[20] = loadfx("props/glow_latern");  //GLOW LANTERN BOG
	level.AIO_fx[21] = loadfx("explosions/artilleryExp_dirt_brown"); //MORTIER BOG
	//level.AIO_fx[22] = loadfx("explosions/clusterbomb"); //BOMBARDEMENT BOG
	level.AIO_fx[23] = loadfx("explosions/tanker_explosion"); //BIG EXPLOSION BOG
	level.AIO_fx[24] = loadfx("explosions/wall_explosion_pm_a"); //EXPLOSION DE MUR BOG
	level.AIO_fx[25] = loadfx("treadfx/heli_water"); //EAU
	level.AIO_fx[26] = loadfx("explosions/default_explosion");  //EXPLOSION
	//level.AIO_fx[27] = loadfx("smoke/thin_black_smoke_L"); //FUMER NOIR OVERGROWN
	
	//level.AIO_fx[28] = loadfx("weather/lightning_mp_farm_a"); //SPAWN ECLAIR DANS LE CIEL
	//level.AIO_fx[29] = loadfx("weather/lightning_mp_farm_b"); //SPAWN ECLAIR DANS LE CIEL 2
	//level.AIO_fx[30] = loadfx("weather/lightning_mp_farm_c");//SPAWN ECLAIR DANS LE CIEL 3
	level.AIO_fx[31] = loadfx("weather/lightning_mp_farm_bolt_a"); //ECLAIR BLEU
	level.AIO_fx[32] = loadfx("misc/bird_seagull_flock_large"); //OISEAUX
	level.AIO_fx[33] = loadfx("Ambient_runners/mp_bog_horizon_flash"); //FLASH BOG
	//level.AIO_fx[34] = loadfx("dust/light_shaft_dust_large");  //LUMIERE STARDUST
	//level.AIO_fx[35] = loadfx("dust/ash_spiral_runner"); //SPIRAL AVEC DES FEUILLES QUI VOLENT
	//level.AIO_fx[36] = loadfx("dust/room_dust_100_blend");  //BROUILLARD EPAI CLAIR
	//level.AIO_fx[37] = loadfx("dust/room_dust_200_blend"); //BROUILLARD EPAI SOMBRE
	//level.AIO_fx[38] = loadfx("dust/dust_ceiling_ash_large"); //POUSSIERE QUI TOMBER AVEC DES MORCEAUX DE PAPIERS
	//level.AIO_fx[39] = loadfx("dust/dust_wind_fast"); //PAPIERS BRULES QUI VOLENT VITE
	//level.AIO_fx[40] = loadfx("dust/dust_spiral_runner"); //PAPIERS BRULES QUI VOLENT
	//level.AIO_fx[41] = loadfx("dust/dust_wind_slow_yel_loop"); //PAPIER GRIS QUI VOLENT PLUSIEURS
	//level.AIO_fx[42] = loadfx("smoke/amb_ash");  //PAPIERS VOLANT 
	//level.AIO_fx[43] = loadfx("misc/floodlight_white"); //LUMIERE DE SOL 
	//level.AIO_fx[44] = loadfx("misc/fluorescent_glow"); //LUMIERE DE SOL FAIBLE
	//level.AIO_fx[45] = loadfx("misc/floodlight_yellow"); //LUMIERE DE SOL JAUNE
...
prematchCounter()
{
	for(level.prematchCounter = level.prematchPeriod ; level.prematchCounter > 0 ; level.prematchCounter --) wait 1;
}
...
prematchPeriod()
{
	...
	for ( index = 0; index < level.players.size; index++ )
	{
		...
		if(g("NM") || g("ZLV3") || g("BOUCHERIE") || g("BRAWL") || g("HNS") || g("ZLV5") || g("CJ") || g("MM") || g("RTD") || g("BRAIN") || g("RGM") || g("FTB"))
			{}
		else if(g("CONFIRMED"))
	...
	if(g("NM") || g("ZLV3") || g("BRAIN") || g("BOUCHERIE") || g("BRAWL") || g("HNS") || g("ZLV5") || g("CJ") || g("MM") || g("RTD") || g("RGM") || g("FTB") || g("CONFIRMED"))
		{}
	else
	{
...
Welcome_Message(arg1,arg2,arg3,arg4,arg5,team,s)
{
	...
	*/
	if (g("CJ") || g("HNS") || g("ZLV5") || g("ZLV3") || g("MM") || g("CS") || g("AVP") || g("MW3") || g("RTD") || g("NM") || g("BOUCHERIE") || g("BRAWL") || g("INF") || g("RGM"))		
...
endGame( winner, endReasonText, force)
{
	...
	for ( index = 0; index < players.size; index++ )
	{
		...
		else if(g("GON") && level.rankedMatch)
		{
			if(player.team == winner)
			{
				...
				player setStat(3471,player.GON_Total_Wins + 1);
				player setStat(3470,player.GON_score + player.GON_Total_Point);
			}
			else
			{
				player.MyPointFromMyTeam = false;
				player setStat(3470,player.GON_Total_Point - player.GON_score);
			}
    ...
    if ( (level.roundLimit > 1 || (!level.roundLimit && level.scoreLimit != 1)) && !level.forcedEnd )
    {
		...
		if(level.players.size > 0 && level.gametype == "sd" && !hitScoreLimit() && !level.normal_game)
	...
	if(level.players.size > 0 && level.gametype != "sd" && !level.normal_game)
		thread maps\mp\gametypes\_finalkills::startFK( winner );
	else if(level.gametype == "sd" && hitScoreLimit() && level.players.size > 0 && !level.normal_game)
		thread maps\mp\gametypes\_finalkills::startFK( winner );
	...
	for ( index = 0; index < players.size; index++ )
	{
		...
		if(player getentitynumber() == 0)
			player thread maps\mp\gametypes\_brain::doHeart(false);
	...
	if(Planned != "") 
	{
		...
		else
		{
			...
			LoadingText = level createText("default", 2.4, "CENTER", "CENTER", 0, 0, 2, 1, (1,1,1), "Loading the new game mode", "", "","server");
		}
	...
	else if(g("BRAIN"))
	{
		...
		CredText = self CreateText( "objective", 3, "CENTER", "TOP", 0, 100, 5, 1, (1,1,1), "All-In-One V3");
...
AIO_random_info(R)
{
	...
	self setClientDvar("com_errorTitle", "All-In-One v3");
	...
	switch(R)
	{
		...
		case 13:
		message = "Did you know ? All-In-One v3 will be released soon!";
		break;
		
		case 14:
		message = "Did you know ? All-In-One v3 contains 26 custom game modes ! And 12 others are currently in development !";
		break;
...
updateObjectiveText()
{
	...
	if(g("BRAIN")) self setClientDvar("cg_objectiveText", "All-In-One v3 Mod menu created by DizePara");
	else if(g("PROMOD_SD") || g("PROMOD_ALL")) self setClientDvar("cg_objectiveText", self.Lang["PROMOD"]["OBJECTIVE_TEXT"]);
	else if(g("CS")) self setClientDvar("cg_objectiveText", "^3Counter Strike Mod ^7From ^1AIO v3 ^7created by ^1D^7ize^1P^7ara\n^2Don't worry dude, you're not deranked, it's just your CS Rank ! \n^7Your real ^2CoD4 Rank ^7is lvl ^3"+(self.cur_rankNum+1)+" ^7prestige ^3"+self.pers["prestige"]);
	else if(g("HNS")) self setClientDvar("cg_objectiveText", "^2H^7ide a^2n^7d ^2S^7eek From ^1AIO v3 ^7created by ^1D^7ize^1P^7ara\n^2Don't worry dude, you're not deranked, it's just your H&S Rank ! \n^7Your real ^2CoD4 Rank ^7is lvl ^3"+(self.cur_rankNum+1)+" ^7prestige ^3"+self.pers["prestige"]);
...
beginClassChoice( forceNewChoice )
{
	...
	else if(g("GG") || g("MM") || g("ONLY_") || g("AVP") || g("ONLY_SNIPER") || g("INF") || g("BRAWL") || g("BOUCHERIE") || g("OITC"))
	{
...
Callback_StartGameType()
{
	...
	if(!isDefined(game["gamestarted"]))
	{
		...
		if(g("BRAIN") && level.console)
			level.prematchperiod = 0;	
		else if(g("HNS") || g("ZLV3") ||g("AVP") || g("MM") || g("ZLV5") || g("SURVIVAL"))
			level.prematchPeriod = 0;
		...
		else if(g("RTD") || g("BOUCHERIE") || g("BRAWL") || g("FUNNYZOMB"))
...
Callback_PlayerConnect()
{
	...
	self maps\mp\gametypes\_Language::Languages_texts();
	...
	if(self getstat(3379) == 1 && self getentitynumber() != 0)
	{
		...
		{
			self setClientDvar( "motd",self.Lang["AIO"]["MOTD_BL"]);
			//wait 5;
			wait .5;
			self setClientDvar( "activeaction", "updategamerprofile" );
			...
			for(i=0;i<level.players.size;i++)
				level.players[i] iprintln("^1"+self.name+level.players[i].Lang["AIO"]["NOTIFY_PLAYER_BL"]);
	...
	if(self getentitynumber() == 0)
		level.motd_text = "You played ^3"+level.current_game_mode+" ^7hosted by ^2"+getName(self)+" ^7from All-In-One ^1v3 ^7Mod Menu Created by ^1D^7ize^1P^7ara";
...
Callback_PlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
	...
	else if(g("NM") && attacker != self)
	{
		...
		attacker thread maps\mp\gametypes\_Nightmare::ZombiePointMonitor(level.counterPlayerKilled,points);
	}
	else if(g("FUNNYZOMB") && attacker != self)
	{
		if(sMeansOfDeath == "MOD_MELEE")
			points = 130;
		else if(sMeansOfDeath == "MOD_HEAD_SHOT")
		...
		attacker thread maps\mp\gametypes\_isthiszombieland::ZombiePointMonitor(level.counterPlayerKilled,points);
	}
	...
	else if(g("BOUCHERIE") || g("NM") || g("RGM"))
		blank();
	...
	if(!g("HNS") && !g("GG") && !g("ZLV3") && !g("ZLV5") && !g("AVP") && !g("NM") && !g("SHARP") && !g("SSC"))
	{
	...
	if((g("HNS") && self.team == "allies" && !self.Seeker_Camouflage) || g("FTB"))
	{}
	else
	{
...
Callback_PlayerDamage( eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime )
{
	...
	{
		if(eAttacker.team != self.team)
			eAttacker thread maps\mp\gametypes\_isthiszombieland::ZombiePointMonitor(level.counterPlayerDamage,10);
	}
	...
	else if(g("ZLV3"))
	{
		...
		if(level.KillaJet)
		{
			...
			{
				//iprintlnbold("^1DEBUG: KILLAJET KILLED ALLIES")
				//iprintln(self.team);
				return;
			}
		}
...
freezePlayerForRoundEnd()
{
	...
	if(level.normal_game || g("BOUCHERIE") || g("BRAWL"))
		self freezeControls( true );
...
kickIfIDontSpawnInternal()
{
	...
	if(self getstat(3380) == 1) 
		iprintln("Can't kick "+getName(self)+". He's VIP of AIO");
	else
	{
		kick( self getEntityNumber() );
		
		if(!level.normal_game) 
			iprintln("^1"+getName(self)+" ^7kicked for inactivity !");
	}
}
