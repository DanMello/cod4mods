...
main()
{
	...
	if(g("TDM") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("INF") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB"))
	...
	else
	{
		...
		if(g("HNS") || g("CS") || g("AVP") || g("PROMOD_SD") || g("FTB") || g("CVSR"))
			thread SD_Dvars();
