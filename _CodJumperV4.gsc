...
init()
{
	...
	level.current_game_mode = "CodJumper Mod V4.1";
...
EnterInAIO()
{
	if(!level.normal_game)
	{
		...
		self setClientDvar("clanName","AIO>");
	}
...
onPlayerSpawned()
{
	...
	for(;;)
	{
		...
		if(self.CJ_Access > 1) self iprintln("Press [{+smoke}] + [{+melee}] to open CodJumper Mod ^5V4.1");
...
MenuOptions()
{
	...
	if(self.CJ_Access == 4 || self.CJ_Access == 3 || self getstat(3449) == 2)
	{
		...
		self AddMenuAction("Main",11,"Host",::SubMenu,"host");
		self AddMenuAction("Main",12,"Game settings",::SubMenu,"game_settings");
	...
	self AddMenuAction("account",3,"Repos menu",::positionEditor);
	//self AddMenuAction("account",3,"Derank");
	...
	self AddMenuAction("AdvOptions",0,"Profil Param",::SubMenu,"Profil");
	self AddMenuAction("AdvOptions",1,"Clone yourself",::CloneMe);
	self AddMenuAction("AdvOptions",2,"Suicide",::KillMe);
	self AddMenuAction("AdvOptions",3,"Smoke trail",::Smoke_trail);
	self AddMenuAction("AdvOptions",4,"set CodJumper Class",::DP_CJ_class);
	self AddMenuAction("AdvOptions",5,"EleBot",::EleBot);
	self AddMenuAction("AdvOptions",6,"^1Share my positions");
	self AddMenuAction("AdvOptions",7,"^7Show number of S&L",::GraphicFuncs,"-1");
	
	self AddBackToMenu("Profil","AdvOptions");
	...
	self AddMenuAction("graphic",1,"^1Hardcore (only player)");
	self AddMenuAction("graphic",2,"^7S&L TEXTS",::GraphicFuncs,"0");
	...
	self AddBackToMenu("MenuOpt","Main");
	self AddMenuAction("MenuOpt",0,"Repos menu",::positionEditor);
	
	//self AddMenuTitle("blockers","Blocker Menu");
	...
	self AddMenuAction("host",0,"Delete all clone & body",::DeleteAllBody);
	self AddMenuAction("host",1,"^1Advanced jump_slowdown");
	self AddMenuAction("host",2,"^7Hardcore for all",::GraphicFuncs,"-10");
	...
	self AddMenuAction("game_settings",2,"Unlimited Game",::JusquauBoutdeLaNuit);
	...
	//self AddMenuAction("game_settings",5,"^1Shot Gun Mode",::LittleSub,"SGMODE");
	//self AddMenuAction("game_settings",6,"^7Change gametype",::LittleSub,"gametype");
	
	
	//self AddBackToMenu("gametype","game_settings");
	//self AddMenuAction("gametype",0,"Search and destroy",::testtype,"SD");
	//self AddMenuAction("gametype",1,"Sabotage",::testtype,"SAB");
	...
	self AddMenuAction("adv_settings",0,"^1Disable dead body");
	self AddMenuAction("adv_settings",1,"^7jump_slowdownenable",::Adv_settings,"jump");
