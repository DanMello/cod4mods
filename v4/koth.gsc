...
main()
{
	...
	else if(g("TDM") || g("RGM") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB"))
		maps\mp\gametypes\war::main();
	else if(g("SD") || g("HNS") || g("CJ") || g("CS") || g("AVP") || g("PROMOD_SD") || g("cachecache") || g("FTB") || g("CVSR") || (g("RGM_SD") && g("RGM")))
	...
	else
	{
		...
		setdvar("party_gametype","koth");
		setdvar("ui_gametype","koth");
		
		if(g("HQ"))
		level.current_game_mode = "Headquarters";
