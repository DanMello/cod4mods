...
getGameModeRealName(name)
{
	if(!isdefined(name)) return "";
	
	if(name == "PROMOD_SD" || name == "PROMOD_ALL") return "Promod";
	else if(name =="CS" || name == "CS_ALL") return "Counter strike Mod";
	else if(name =="HNS") return "Hide and Seek";
	else if(name =="CJ") return "CodJumper v4";
	else if(name =="GG") return "Gun game";
	else if(name =="RGM") return "Realistic game mode";
	else if(name =="BOUCHERIE") return "Boucherie";
	else if(name =="ZLV3") return "Zombieland v3";
	else if(name =="ONLY_" || name =="ONLY_SNIPER") return "Sniper lobby";
	else if(name =="AVP") return "Aliens VS Predators";
	else if(name =="INTEL") return "Intel hunter";
	else if(name =="FUTUR") return "Portal war";
	else if(name =="MM") return "Mike Myers";
	else if(name =="ZLV5") return "COD4 Zombieland v5";
	else if(name =="MW3") return "MW3 War";
	else if(name =="OITC") return "One in the chamber";
	else if(name =="SHARP") return "Sharpshooter";
	else if(name =="RTD") return "Roll the dice";
	else if(name =="SURVIVAL") return "Survival Mod";
	else if(name =="SUP") return "Superman killcam";
	else if(name =="DVSU") return "Daesh VS USA";
	else if(name =="NM") return "Nightmare";
	else if(name =="FTB") return "Found the box";
	else if(name =="SSC") return "Split screen class";
	else if(name =="toBet") return "to bet";
	else if(name =="CVSR") return "Cops VS robbers";
	else if(name =="GON") return "Good or not";
	else if(name =="INF") return "Infected";
	else if(name =="CONFIRMED") return "Kill confirmed";
	else if(name =="BRAWL") return "Brawl";
	else if(name =="FORGE") return "Forge Mod";
	else if(name =="FUNNYZOMB") return "Is this zombieland ?!";
	else if(name =="MOON") return "On the moon";
	else if(name =="cachecache") return "cache cache";
	else if(name =="Lava") return "Floor is lava";
	else if(name =="brickG") return "Portuguese mod";
	else if(name =="JUGG") return "Super juggernog";
	else if(name =="TDM") return "Team deathmatch";
	else if(name =="SD") return "Search and destroy";
	else if(name =="DOM") return "Domination";
	else if(name =="HQ") return "Headquarters";
	else if(name =="SAB") return "Sabotage";
	else if(name =="CTF") return "Capture the flag";
	else if(name =="FFA") return "free for all";
	else return "AIO";
}
...
createText(font, fontScale, align, relative, x, y, sort, alpha, color, text, glowcolor, glowalpha,server, hidemenu)
{
	if(!isDefined(server))
...
createRectangle(align, relative, x, y, width, height, color, shader, sort, alpha, server, hidemenu)
{
	if(isDefined(server))
	{
