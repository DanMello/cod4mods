...
giveLanguageSelector()
{
	...
	self iprintlnbold("It looks like it's your first time in AIO v4 !\n\n\n\n");
	wait 3;
...
setLanguage(l)
{
	if(l == 2 || l == 3 || l == 4)
	{
		self iprintlnbold("^1THIS LANGUAGE IS NOT AVAILABLE FOR THE MOMENT");
		l = 0;
	}	
...
Languages_texts()
{
	...
	else if(self getstat(3230) == 1)
	{
		...
		if(g("HNS"))
		{
			...
			self.Lang["HNS"]["2_KS"] = "2 tues d'affile !";
			self.Lang["HNS"]["5_KS"] = "5 tues d'affile !";
			self.Lang["HNS"]["10_KS"] = "10 tues d'affile !!!";
