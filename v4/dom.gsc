...
main()
{
	...
	else if(g("TDM") || g("RGM") || g("CJ") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB"))
		maps\mp\gametypes\war::main();	
	else if(g("SD") || g("HNS") || g("CS") || g("AVP") || g("PROMOD_SD") || g("FTB") || g("CVSR") || g("cachecache") || (g("RGM_SD") && g("RGM")))	
	...
	else 
	{
		...
		setdvar("party_gametype","dom");
		setdvar("ui_gametype","dom");
		
		if(g("DOM"))
		level.current_game_mode = "Domination";
