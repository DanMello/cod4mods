...
main()
{
	...
	if(g("TDM") || g("RGM")  || g("CJ") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB") || g("CJ") )
		maps\mp\gametypes\war::main();
	else if(g("SD") || g("HNS") || g("CS") || g("cachecache") || g("AVP") || g("PROMOD_SD") || g("FTB") || g("CVSR") || (g("RGM_SD") && g("RGM")))
	...
	else
	{
		...
		setdvar("party_gametype","sab");
		setdvar("ui_gametype","sab");
		
		if(g("SAB"))
		level.current_game_mode = "Sabotage";
...
SAB_DVARS()
{
	if(g("DVSU"))
	{
		...
		//setDvar( "scr_sab_planttime", "6.5" );
		//setDvar( "scr_sab_bombtimer", "50" );
		//setDvar( "scr_sab_defusetime", "7.7" );
...
onPlayerKilled(eInflictor, attacker, iDamage, sMeansOfDeath, sWeapon, vDir, sHitLoc, psOffsetTime, deathAnimDuration)
{
	...
	thread maps\mp\gametypes\sd::checkAllowSpectating();
}
...
onTimeLimit()
{
	if(g("HNS"))
	{
		//maps\mp\gametypes\sd::sd_endGame(  );
		
		[[level._setTeamScore]]( "allies", [[level._getTeamScore]]( "allies" ) + 1 );
	
		 
		thread maps\mp\gametypes\_globallogic::endGame("allies", "Seekers didn't found Hiders" );
