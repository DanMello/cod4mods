...
init()
{
	...
	level.gameModeDevName = "brickG";
	level.current_game_mode = "Portuguese Mod";
...
onPlayerSpawned()
{
	...
	self thread HUDDD();
	self thread Bouch_Welcome("WEL_TITLE","WEL_SHADER",undefined,"hud_icon_usp_45","Portuguese gun", undefined,(255/255, 80/255, 0/255),-150);
...
HUDDD()
{
	...
	self.HUD_boucherie = self createRectangle("BOTTOM RIGHT", "BOTTOM RIGHT", -10 + self.AIO["safeArea_X"], -10 + self.AIO["safeArea_Y"]*-1, 50, 50, (1,1,1), "hud_icon_usp_45", 1, 1);
