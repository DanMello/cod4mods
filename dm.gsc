...
main()
{
	...
	else if(g("TDM") || g("ZLV5") || g("ZLV3") || g("MW3") || g("MM") || g("NM") || g("SSC") || g("toBet") || g("INF") || g("RGM") || g("GON") || g("CONFIRMED") || g("FUNNYZOMB"))
	...
	else
	{
		...
		if(g("FFA") || g("SUP") || g("GG") || g("BOUCHERIE") || g("BRAWL")|| g("RTD") || g("SHARP") || g("SURVIVAL") || g("ONLY_") || g("OITC") || g("INTEL") || g("ONLY_SNIPER"))
			DM_Dvars();
...
DM_Dvars()
{
	...
	{
		setDvar("scr_dm_roundlimit", 1);
		setDvar("scr_dm_timelimit", 5.15 );
		setDvar("scr_dm_scorelimit", 0 );
		setDvar("scr_dm_numlives", 0);
	}
	else if(g("BOUCHERIE") || g("BRAWL"))
	{
		setDvar("scr_dm_roundlimit", 1);
		setDvar("scr_dm_timelimit", 5 );
